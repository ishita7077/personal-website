# Harvard Business School — answer framework

## Handoff structure (from mba_final_handoff_static/deep-research-report (2).md)

**Validated format (paraphrased from handoff):** 1:1 application-based interview tailored to your file; ~30 minutes.

**Distinctive elements:** Post-Interview Reflection due within 24 hours (guidance often cited as ~300–450 words).

**Interviewer profile (handoff):** MBA Admissions Board member who reviewed your application

**Community / texture note:** Reports emphasize file-aware, detail-probing questions (Clear Admit pattern in handoff CSV).
...
- https://www.hbs.edu/mba/your-interview
- https://www.hbs.edu/mba/your-interview/get-to-know-us
- https://www.hbs.edu/mba/admissions/application-process
- https://www.hbs.edu/mba/blog/peek-event-for-college-students

## Community / applicant texture (step5 CSV URLs)

- https://www.clearadmit.com/interview-reports/school/harvard/
