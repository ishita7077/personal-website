...
const myDevicesDesktop: BluetoothDevice[] = [
  { name: "Ish's Magic Keyboard", connected: true, battery: 91, type: "keyboard" },
  { name: "Ish's Magic Trackpad", connected: true, battery: 20, type: "trackpad" },
  { name: "Nothing Headphones", connected: false, type: "headphones" },
  { name: "Ish's AirPods Max", connected: false, type: "airpods-max" },
  { name: "Ish's AirPods Pro", connected: false, type: "airpods" },
  { name: "Flipper Reg0l1", connected: false, type: "headphones" },
];

const myDevicesMobile = [
  { name: "Nothing Headphones", connected: true },
  { name: "Ish's AirPods Max", connected: false },
  { name: "Ish's AirPods Pro", connected: false },
    ...
    return (
      <div className="px-4 py-4 space-y-4">
        ...
        <p className="text-sm text-muted-foreground px-2">
          This iPhone is discoverable as &quot;Ishita&apos;s iPhone&quot; while Bluetooth Settings is open.
        </p>
      ...
      {bluetoothEnabled && (
        <>
          ...
          <p className="text-xs text-muted-foreground py-4 border-b border-border/50">
            This Mac is discoverable as &quot;Ish&apos;s MacBook Air&quot; while Bluetooth Settings is open.
          </p>
