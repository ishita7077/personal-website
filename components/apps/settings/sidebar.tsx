...
const connectivityItems = [
  ...
  { id: "wifi", name: "Wi-Fi", icon: <Wifi className="w-5 h-5 text-white" />, iconBg: "bg-blue-500", type: "value" as const, value: "Starbucks" },
                ...
                {showAppleAccount && (
                  ...
                  >
                    ...
                    <div className="text-left flex-1">
                      <div className="font-semibold text-lg">Ishita</div>
                ...
                <div className="py-2">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="font-medium text-xs">Ishita</div>
