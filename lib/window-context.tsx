...
// Notes in front, Messages just behind.
const DESKTOP_DEFAULT_CONFIG = {
  windows: [
    { appId: "messages", position: { x: 520, y: 80 }, size: { width: 720, height: 520 } },
    { appId: "notes", position: { x: 140, y: 60 }, size: { width: 980, height: 700 } },
  ],
  focusedAppId: "notes",
} as const;
